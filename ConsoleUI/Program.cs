...
namespace ConsoleUI
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"The total for cart 1 is {cart.GenerateTotal(SubTotalAlert, CalculateLeveledDiscount, AlertUser):C2}");
            Console.WriteLine();
            // anonymous delegate --> shorthand way instead of creating separate methods
            decimal total = cart.GenerateTotal((subTotal) => Console.WriteLine($"the subtotal for cart 2 is {subTotal:C2}"),
                ...
                (message) => Console.WriteLine($"Cart 2 Alert: {message:C2}"));
